...
public class DefaultDubboConfigBinder extends AbstractDubboConfigBinder {
    ...
    public <C extends AbstractConfig> void bind(String prefix, C dubboConfig) {
        ...
        // Get properties under specified prefix from PropertySources   从 PropertySources 获取指定前缀下的属性
        Map<String, Object> properties = getSubProperties(getPropertySources(), prefix);
        // Convert Map to MutablePropertyValues  将 Map 转换为 MutablePropertyValues
