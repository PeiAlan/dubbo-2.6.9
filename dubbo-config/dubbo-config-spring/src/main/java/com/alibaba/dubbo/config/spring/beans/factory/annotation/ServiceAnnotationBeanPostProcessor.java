...
public class ServiceAnnotationBeanPostProcessor implements BeanDefinitionRegistryPostProcessor, EnvironmentAware,
    ...
    /**
     * bean的实例化过程中会调用到  postProcessBeanDefinitionRegistry
     * {@link AbstractApplicationContext#refresh()} 中 invokeBeanFactoryPostProcessors
     * {@link org.springframework.context.support.PostProcessorRegistrationDelegate}
     * @param registry
    ...
    private void registerServiceBean(BeanDefinitionHolder beanDefinitionHolder, BeanDefinitionRegistry registry,
        ...
        // 拿到beanClass对应的接口类，由class类找interface类，比如根据 userServiceImpl.class 去找 userService 的接口类
        Class<?> interfaceClass = resolveServiceInterfaceClass(beanClass, service);

        String annotatedServiceBeanName = beanDefinitionHolder.getBeanName();

        // 创建ServiceBean的beanDefinition对象，把设置的配置类也装配到serviceBean中
        // 比如 ProviderConfig  MonitorConfig  ApplicationConfig  ModuleConfig  RegistryConfig  ProtocolConfig
